...
void GtpcGenerator::generateDistricts() {
   ...
   std::string header_covers = "Warehouse.id|District.id";
...
void GtpcGenerator::generateCustomerAndHistory() {
   ...
   std::string header_serves = "District.id|Customer.id";
   std::string header_isLocatedIn = "Customer.id|Nation.id";
...
void GtpcGenerator::generateStock() {
   ...
   std::string header_wHasStock = "Warehouse.id|Stock.id";
   std::string header_iHasStock = "Item.id|Stock.id";
   std::string header_hasSupplier = "Stock.id|Supplier.id";
...
void GtpcGenerator::generateOrdersAndOrderLines() {
   ...
   std::string header_hasPlaced = "Customer.id|Order.id";
   std::string header_olHasStock = "OrderLine.id|Stock.id";
//    std::string header_hasItem = "OrderLine.id|Item.id";
   std::string header_contains = "Order.id|OrderLine.id";
...
void GtpcGenerator::generateNations() {
   ...
   std::string header_isPartOf = "Nation.id|Region.id";
...
void GtpcGenerator::generateSuppliers() {
   ...
   std::string header_isLocatedIn = "Supplier.id|Nation.id";
