...
std::unique_ptr<TargetMachine> JitFromScratch::createTargetMachine(llvm::ExitOnError ExitOnErr) {
...
std::string JitFromScratch::mangle(llvm::StringRef UnmangledName) {
...
Error JitFromScratch::applyDataLayout(llvm::Module &M) {
...
Expected<JITTargetAddress> JitFromScratch::getFunctionAddr(llvm::StringRef Name) {
...
std::unique_ptr<DynamicLibrarySearchGenerator> JitFromScratch::createHostProcessResolver() {
