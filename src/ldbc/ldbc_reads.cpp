...
double run_query_5_c(graph_db_ptr gdb) {
    ...
    //SF_10
    /*std::vector<uint64_t> commentIds = {4398085711669, 5497581697867, 8796113056132, 3298560907184, 4947822939393,
...
double run_query_7_p(graph_db_ptr gdb) {
    //SF_1
    std::vector<uint64_t> postIds = {1374392023251, 549760018385, 137439936821, 1786707720205, 4359157,
