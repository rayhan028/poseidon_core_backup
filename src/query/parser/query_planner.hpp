...
public:
  ...
  std::any
  visitIndex_scan_op(poseidonParser::Index_scan_opContext *ctx) override;
  ...
  std::any visitForeach_relationship_op(
      poseidonParser::Foreach_relationship_opContext *ctx) override;
  std::any visitCrossjoin_op(poseidonParser::Crossjoin_opContext *ctx) override;
  std::any
  visitLeftouterjoin_op(poseidonParser::Leftouterjoin_opContext *ctx) override;
  ...
  std::any visitRemove_relationship_op(
      poseidonParser::Remove_relationship_opContext *ctx) override;
  std::any
  visitDetach_node_op(poseidonParser::Detach_node_opContext *ctx) override;

  std::any visitAlgorithm_op(poseidonParser::Algorithm_opContext *ctx) override;
  std::any
  visitAlgo_param_list(poseidonParser::Algo_param_listContext *ctx) override;

  std::any
  visitProperty_list(poseidonParser::Property_listContext *ctx) override;
  ...
  std::any
  visitEquality_expr(poseidonParser::Equality_exprContext *ctx) override;
  std::any
  visitRelational_expr(poseidonParser::Relational_exprContext *ctx) override;
  std::any
  visitAdditive_expr(poseidonParser::Additive_exprContext *ctx) override;
  std::any visitMultiplicative_expr(
      poseidonParser::Multiplicative_exprContext *ctx) override;
  ...
  std::any visitValue(poseidonParser::ValueContext *ctx) override;
...
private:
  ...
  qop_ptr qop_append(qop_ptr parent, std::shared_ptr<T> qop) {
    if (parent != nullptr)
      parent->connect(qop,
                      std::bind(&T::process, dynamic_cast<T *>(qop.get()),
  ...
  qop_ptr qop_append2(qop_ptr parent, std::shared_ptr<T> qop) {
    if (parent != nullptr)
      parent->connect(qop,
                      std::bind(&T::process, dynamic_cast<T *>(qop.get()),
                                std::placeholders::_1, std::placeholders::_2),
                      std::bind(&T::finish, dynamic_cast<T *>(qop.get()),
                                std::placeholders::_1));
    return qop;
  }
